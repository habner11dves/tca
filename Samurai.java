...
public class Samurai {
    ...
    public static void main(String[] args, int player1) throws InterruptedException {
        int player2 = samuraiVs(); // Recebe o Personagem escolhido do player 2

        personagemVida.main(args, player1, player2); // Chama o main da class Vida
    }

    public static int samuraiVs() throws InterruptedException { // Metodo para escolher o personagem da CPU
    ...
    public static void samuraiSamurai() { // Metodo com a imagem do Samurai VS Samurai
        String[] samuraiSamurai = {
        "                                           ██                               █                                           \n" + //
        "                                           ░░░                            ░░░                                           \n" + //
        "                                           ▒▒░█                          █░▒▒                                           \n" + //
        "                  ▒▒░▒█            █░░     ▓█░█                          █░█▒     ▒░█             ▒░░▒                  \n" + //
        ...
        for (int i = 0; i < samuraiSamurai.length; i++) {
            System.out.println(samuraiSamurai[i]);
        }
        
    }

    public static void samuraiMago() { // Metodo com a imagem do Samurai VS Mago
        String[] samuraiMago = {
        "                                           ██               \n" + //
        "                                           ░░░              \n" + //
        "                                           ▒▒░█             \n" + //
        ...
        for (int i = 0; i < samuraiMago.length; i++) {
            System.out.println(samuraiMago[i]);
        }
    }

    public static void samuraiCavaleiro() { // Metodo com a imagem do Samurai VS Cavaleiro
        String[] samuraiCavaleiro = {
        "                                           ██               \n" + //
        "                                           ░░░              \n" + //
        "                                           ▒▒░█             \n" + //
        "                  ▒▒░▒█            █░░     ▓█░█             \n" + //
        ...
        for (int i = 0; i < samuraiCavaleiro.length; i++) {
            System.out.println(samuraiCavaleiro[i]);
        }
    }

    public static void samuraiBarbaro() { // Metodo com a imagem do Samurai VS Barbaro
        String[] samuraiBarbaro = {
        "                                           ██               \n" + //
        "                                           ░░░              \n" + //
        "                                           ▒▒░█             \n" + //
        "                  ▒▒░▒█            █░░     ▓█░█             \n" + //
        ...
        for (int i = 0; i < samuraiBarbaro.length; i++) {
            System.out.println(samuraiBarbaro[i]);
        }
    }
}