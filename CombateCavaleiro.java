...
public class CombateCavaleiro {
    public static final String VERMELHO = "\u001B[31m";
    public static final String VERDE = "\u001B[32m";
    public static final String AMARELO = "\u001B[33m";
    public static final String RESET = "\u001B[0m";
    static int vidaMax1 = 1100;
    static int vidaAtual1 = 1100;

    static int vidaMax2 = 1100;
    static int vidaAtual2 = 1100;

    void cavaleiro() { // Imagem do Cavaleiro
        String[] aslan = {
            "\t    ▀▀█  ▄▄   ▄▀█ ▀█▀ █▀█ █▀▀ █░█ █▀\n" + //
            "\t    ▄██  ░░   █▀█ ░█░ █▀▄ ██▄ █▄█ ▄█\n\n" +
            "                     ▒███░                                  \n" + //
        ...
        for (int i = 0; i < aslan.length; i++) {
            System.out.println(aslan[i]);
        }
    }

    public static int mostrarBarraP1() { // Metodo para mostrar a barra de vida quando o cavaleiro for o player 1
        if (vidaAtual1 < 0) {
            vidaAtual1 = 0;
        }
        int tamanhoBarra = 80;
    ...
    public static int mostrarBarraP2() { // Metodo para mostrar a barra de vida quando o cavaleiro for o player 2
        if (vidaAtual2 <= 0) {
            vidaAtual2 = 0;
        }
        int tamanhoBarra = 80;
