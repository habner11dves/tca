...
public class CombateBarbaro {
    public static final String VERMELHO = "\u001B[31m";
    public static final String VERDE = "\u001B[32m";
    public static final String AMARELO = "\u001B[33m";
    public static final String RESET = "\u001B[0m";
    static int vidaMax1 = 1200;
    static int vidaAtual1 = 1200;

    static int vidaMax2 = 1200;
    static int vidaAtual2 = 1200;

    void barbaro() { // Imagem do barbaro
        String[] sansan = {
            "\t    █░█   ▄▄   █▀ ▄▀█ █▄░█ █▀ ▄▀█ █▄░█\n" + //
            "\t    ▀▀█   ░░   ▄█ █▀█ █░▀█ ▄█ █▀█ █░▀█\n\n" +
            "                    ██▓               ███                   \n" + //
        ...
        for (int i = 0; i < sansan.length; i++) {
            System.out.println(sansan[i]);
        }
    }

    public static int mostrarBarraP1() { // Metodo para mostrar a barra de vida quando o barbaro for o player 1
        if (vidaAtual1 < 0) {
            vidaAtual1 = 0;
        }
        int tamanhoBarra = 80;
    ...
    public static int mostrarBarraP2() { // Metodo para mostrar a barra de vida quando o barbaro for o player 2
        if (vidaAtual2 <= 0) {
            vidaAtual2 = 0;
        }
        int tamanhoBarra = 80;
