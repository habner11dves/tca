...
public class Barbaro {
    ...
    public static void main(String[] args, int player1) throws InterruptedException {
        int player2 = barbaroVs(); // Recebe o Personagem escolhido do player 2

        personagemVida.main(args, player1, player2); // Chama o main da class Vida
    }

    public static int barbaroVs() throws InterruptedException { // Metodo para escolher o personagem da CPU
    ...
    public static void barbaroBarbaro() { // Metodo com a imagem do Barbaro VS Barbaro
        String[] barbaroBarbaro = {
        "                    ██▓               ███                                      ███               ███                    \n" + //
        "                  ▓▒▒██               █▒▒█                                    █▒▒█               ██▒▒▓█                 \n" + //
        "                  █▒▒▒██ ███▒▒▒▒▓██  █▒▒▒█                                    █▒▒▒██ ██▓▒▒▒▒███ ██▒▒▒██                 \n" + //
        "                  ▒█▒▒▒▒▒█▓▓▓▓▒▒▒▒▒█▒▒▒▒█▓                                    ▓█▒▒▒▒█▓▒▒▒▒▓▓▓▓█▒▒▒▒▒█▓                  \n" + //
        ...
        for (int i = 0; i < barbaroBarbaro.length; i++) {
            System.out.println(barbaroBarbaro[i]);
        }
    }

    public static void barbaroSamurai() {  // Metodo com a imagem do Barbaro VS Samurai
        String[] barbaroSamurai = {
        "                                                                            █                                           \n" +
        "                                                                          ░░░                                           \n" +
        "                                                                         █░▒▒                                           \n" +
        "                                                                         █░█▒     ▒░█             ▒░░▒                  \n" +
        ...
        for (int i = 0; i < barbaroSamurai.length; i++) {
            System.out.println(barbaroSamurai[i]);
        }
    }

    public static void barbaroMago() { // Metodo com a imagem do Barbaro VS Mago
        String[] barbaroMago = {
        "                                                                            ▒▒▒                                         \n" +
        "                                                                           ░▓▓▓▒                                        \n" +
        "                    ██▓               ███                                 ░▓▓▒▒▓░                                       \n" + //
        ...
        for (int i = 0; i < barbaroMago.length; i++) {
            System.out.println(barbaroMago[i]);
        }
    }

    public static void barbaroCavaleiro() { // Metodo com a imagem do Barbaro VS Cavaleiro
        String[] barbaroCavaleiro = {
        "                    ██▓               ███                   \n" + //
        "                  ▓▒▒██               █▒▒█                                                    ░███▓                     \n" + //
        "                  █▒▒▒██ ███▒▒▒▒▓██  █▒▒▒█                                                  ▓▓▓▓▓▒▒▒▓                   \n" + //
        "                  ▒█▒▒▒▒▒█▓▓▓▓▒▒▒▒▒█▒▒▒▒█▓                               ▓░░▓             ████████▓▓▒▓                  \n" + //
        ...
        for (int i = 0; i < barbaroCavaleiro.length; i++) {
            System.out.println(barbaroCavaleiro[i]);
        }
    }
